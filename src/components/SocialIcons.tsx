  ...
  return (
    <div className="icons-section">
      <div className="social-icons" data-cursor="icons" id="social">
        <span>
          <a href="https://github.com/Junaid0910" target="_blank">
            <FaGithub />
          </a>
        </span>
        <span>
        ...
        <span>
          <a href="https://www.instagram.com/neurotic_zx_/" target="_blank">
            <FaInstagram />
          </a>
        </span>
      </div>
      <a className="resume-button" href="/images/SHAIK JUNAID RESUME SD.pdf" target="_blank">
